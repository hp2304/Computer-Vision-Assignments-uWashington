...
class HOG_OUT(Structure):
    _fields_ = [("n", c_int), ("data", POINTER(c_float))]

class LBPH_OUT(Structure):
    _fields_ = [("lbp_im", IMAGE), ("n", c_int), ("data", POINTER(c_int))]
...
projective_resize = lib.projective_resize
projective_resize.argtypes = [IMAGE, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int]
projective_resize.restype = IMAGE
...
get_lbph_features = lib.get_lbph_features
get_lbph_features.argtypes = [IMAGE, c_float, c_int, c_int]
get_lbph_features.restype = LBPH_OUT

get_hog_features = lib.get_hog_features
get_hog_features.argtypes = [IMAGE]
...
findCircles = lib.findCircles
findCircles.argtypes = [IMAGE, IMAGE, c_double, c_int, c_int]
findCircles.restype = IMAGE
